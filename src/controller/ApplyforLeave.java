...
public class ApplyforLeave extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(itr.hasNext())
		{
			...
			List leave_type = lehd.findByQuery("From leave_entitlement where employee=?", regdetailsvo.getId());
			ss.setAttribute("leave_list", leave_type);
		}else
		{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		try{
		String s  = request.getParameter("ApplyforLeaveUsername");
		String s1 = request.getParameter("ApplyforLeaveLeaveType");
		String s2 = request.getParameter("ApplyforLeaveperiod");
	    			    ...
	    			    while(itr_.hasNext())
	    			    {
	    					...
	    					*/
	    			    	...
	    			    	if((datefrom.isAfter(storedfrom1) && datefrom.isBefore(storedto1)) || (dateto.isAfter(storedfrom1) && dateto.isBefore(storedto1) || storedfrom1.isEqual(datefrom) || storedto1.isEqual(dateto) )){
	    		    			...
	    		    			response.sendRedirect("Admin/ApplyforLeave.jsp");
	    		    			obj1.wait(3000);
	    						}
	    			    	else{
