...
@font-face {
	...
	src: local('Raleway Thin'), local('Raleway-Thin'),
		url(http://fonts.gstatic.com/s/raleway/v8/RJMlAoFXXQEzZoMSUteGWD8E0i7KZn-EPnyo3HZu7kw.woff)
		format('woff');
}
...
@font-face {
	...
	src: local('Raleway ExtraLight'), local('Raleway-ExtraLight'),
		url(http://fonts.gstatic.com/s/raleway/v8/8KhZd3VQBtXTAznvKjw-kxsxEYwM7FgeyaSgU71cLG0.woff)
		format('woff');
}
...
@font-face {
	...
	src: local('Raleway Light'), local('Raleway-Light'),
		url(http://fonts.gstatic.com/s/raleway/v8/-_Ctzj9b56b8RgXW8FAriRsxEYwM7FgeyaSgU71cLG0.woff)
		format('woff');
}
...
@font-face {
	...
	font-weight: 400;
	src: local('Raleway'),
		url(http://fonts.gstatic.com/s/raleway/v8/IczWvq5y_Cwwv_rBjOtT0w.woff)
		format('woff');
}
...
@font-face {
	...
	src: local('Raleway Medium'), local('Raleway-Medium'),
		url(http://fonts.gstatic.com/s/raleway/v8/CcKI4k9un7TZVWzRVT-T8xsxEYwM7FgeyaSgU71cLG0.woff)
		format('woff');
}
...
@font-face {
	...
	src: local('Raleway SemiBold'), local('Raleway-SemiBold'),
		url(http://fonts.gstatic.com/s/raleway/v8/xkvoNo9fC8O2RDydKj12bxsxEYwM7FgeyaSgU71cLG0.woff)
		format('woff');
}
...
@font-face {
	...
	src: local('Raleway Bold'), local('Raleway-Bold'),
		url(http://fonts.gstatic.com/s/raleway/v8/JbtMzqLaYbbbCL9X6EvaIxsxEYwM7FgeyaSgU71cLG0.woff)
		format('woff');
}
...
@font-face {
	...
	src: local('Raleway ExtraBold'), local('Raleway-ExtraBold'),
		url(http://fonts.gstatic.com/s/raleway/v8/1ImRNPx4870-D9a1EBUdPBsxEYwM7FgeyaSgU71cLG0.woff)
		format('woff');
}
</style> -->
...
<body>
	...
	<%@ include file="Common.jsp" %>
						...
						<div class="col-md-6 col-lg-3 col-sm-6">
							<div class="panel panel-default panel-white core-box">
								<div class="panel-tools">
									<a href="#" class="btn btn-xs btn-link panel-close"> <i
										class="fa fa-times"></i>
									</a>
								</div>
								<div class="panel-body no-padding">
									...
									<div class="padding-20 core-content">
										...
										<span class="subtitle"> Lorem ipsum dolor sit amet,
								...
								<div class="panel-footer clearfix no-padding">
									...
									<a href="#"
										...
										title="More Options"><i class="fa fa-cog"></i></a> <a href="#"
								...
								<div class="e-slider owl-carousel owl-theme">
									<div class="item">
										<div class="panel-body">
											<div class="core-box">
												<div class="text-dark text-bold">Working on</div>
												<div class="text-white space15">
													Navigation Illustration (<i>corporate website redesign</i>)
												</div>
												<div
													class="progress progress-xs transparent-black no-radius space5">
													<div aria-valuetransitiongoal="88"
														class="progress-bar progress-bar-success partition-white animate-progress-bar"></div>
												</div>
												<div class="text-light">Leave Time</div>
												<div class="text-white text-extra-large pull-left">2h
													38m</div>
												<div class="text-white text-large pull-right">
													<a href="#" class="btn btn-xs btn-light-blue"><i
														class="fa fa-pause"></i> Pause</a> <a href="#"
														class="btn btn-xs btn-light-blue"><i
														class="fa fa-check"></i> Complete</a>
												</div>
											</div>
										</div>
										<div class="padding-10">
											<span class="bold-text">1527</span><span class="text-light">
												people share this goal </span> <a href="#"
												class="view-more pull-right text-dark text-bold"> View
												More <i class="fa fa-angle-right text-light"></i>
											</a>
										</div>
									</div>
									<div class="item">
										<div class="panel-body">
											<div class="core-box">
												<div class="text-dark text-bold">Working on</div>
												<div class="text-white space15">Prepare Commercial
													Offer For Mobile App</div>
												<div
													class="progress progress-xs transparent-black no-radius space5">
												...
												<div class="text-light">Leave Time</div>
												<div class="text-white text-extra-large pull-left">8h
													56m</div>
												<div class="text-white text-large pull-right">
													<a href="#" class="btn btn-xs btn-light-blue"><i
														class="fa fa-pause"></i> Pause</a> <a href="#"
									...
									<div class="item">
										<div class="panel-body">
											<div class="core-box">
												<div class="text-dark text-bold">Working on</div>
												<div class="text-white space15">Release iPhone Update
												</div>
												<div
													class="progress progress-xs transparent-black no-radius space5">
							...
							<div class="panel panel-green">
								<div class="e-slider owl-carousel owl-theme">
									<div class="item">
										<div class="panel-body">
											<div class="core-box">
												<div class="text-dark text-bold space15">SOCIAL</div>
												<div class="space5">
													<i class="fa fa-github fa-4x pull-left"></i> Lorem ipsum
													dolor sit amet, consectetuer adipiscing elit, sed diam
													nonummy. <br /> Ut enim ad minim veniam...
												</div>
												<span class="text-light text-small block pull-right">
													<i class="fa fa-clock-o"></i> 11 min ago
												</span>
											</div>
										</div>
										<div class="padding-10">
									...
									<div class="item">
										<div class="panel-body">
											<div class="core-box">
												<div class="text-dark text-bold space15">SOCIAL</div>
												<div class="space5">
													<i class="fa fa-facebook fa-4x pull-left"></i> Lorem ipsum
													dolor sit amet, consectetuer adipiscing elit, sed diam
													nonummy ibh euismod tincidunt.
												</div>
												<span class="text-light text-small block pull-right">
													<i class="fa fa-clock-o"></i> 27 min ago
												</span>
											</div>
										</div>
										<div class="padding-10">
									...
									<div class="item">
										<div class="panel-body">
											<div class="core-box">
												<div class="text-dark text-bold space15">SOCIAL</div>
												<div class="space5">
													<i class="fa fa-twitter fa-4x pull-left"></i> Lorem ipsum
													dolor sit amet, consectetuer adipiscing elit, sed diam
													nonummy ibh euismod tincidunt.
												</div>
												<span class="text-light text-small block pull-right">
													<i class="fa fa-clock-o"></i> 56 min ago
												</span>
											</div>
										</div>
										<div class="padding-10">
								...
								<div class="panel panel-note">
									<div class="e-slider owl-carousel owl-theme">
										<div class="item">
											...
											<div class="panel-body space10">
												...
												<div class="note-content">
													...
													iure reprehenderit in <strong>voluptate velit</strong> esse
													cillum dolore eu fugiat nulla pariatur. <br> Excepteur
													sint obcaecat cupiditat non proident, sunt in culpa qui
													officia deserunt mollit anim id est laborum. <br> Nemo
													enim ipsam voluptatem, quia voluptas sit, aspernatur aut
													odit aut fugit, sed quia consequuntur magni dolores eos,
													qui ratione voluptatem sequi nesciunt, neque porro quisquam
													est, qui dolorem ipsum, quia dolor sit, amet, consectetur,
													adipisci v'elit, sed quia non numquam eius modi tempora
													incidunt, ut labore et dolore magnam aliquam quaerat
													voluptatem. <br> Ut enim ad minima veniam, quis
													nostrum exercitationem ullam corporis suscipit laboriosam,
													nisi ut <strong>aliquid ex ea commodi consequatur?</strong>
													<br> Quis autem vel eum iure reprehenderit, qui in ea
													...
													rerum facilis est et expedita distinctio. <br> Nam
											...
											<div class="panel-footer">
												<div class="avatar-note">
													<img src="images/avatar-2-small.jpg" alt="">
												</div>
										...
										<div class="item">
											...
											<div class="panel-body space10">
												<div class="note-short-content">Excepteur sint
													obcaecat cupiditat non proident, sunt in culpa qui officia
													deserunt mollit anim id est laborum. Nemo enim ipsam
													voluptatem, quia voluptas sit...</div>
												<div class="note-content">
													...
													consectetur, adipisci v'elit, sed quia non numquam eius
													modi tempora incidunt, ut labore et dolore magnam aliquam
													quaerat voluptatem. <br> Ut enim ad minima veniam,
													quis nostrum exercitationem ullam corporis suscipit
													laboriosam, nisi ut <strong>aliquid ex ea commodi
														consequatur?</strong> <br> Quis autem vel eum iure
													reprehenderit, qui in ea voluptate velit esse, quam nihil
													molestiae consequatur, vel illum, qui dolorem eum fugiat,
													quo voluptas nulla pariatur? <br> Nam libero tempore,
													...
													sint et molestiae non recusandae. <br> Itaque earum
											...
											<div class="panel-footer">
												...
												<div class="avatar-note">
													<img src="images/avatar-3-small.jpg" alt="">
												</div>
										...
										<div class="item">
											...
											<div class="panel-body space10">
												<div class="note-short-content">At vero eos et
												...
												<div class="note-content">
													...
													expedita distinctio. <br> Excepteur sint obcaecat
													cupiditat non proident, sunt in culpa qui officia deserunt
													mollit anim id est laborum. <br> Nemo enim ipsam
													...
													corporis suscipit laboriosam, nisi ut <strong>aliquid
														ex ea commodi consequatur?</strong>
												</div>
											</div>
											<div class="panel-footer">
												<div class="note-options pull-right">
												...
												<div class="avatar-note">
													<img src="images/avatar-4-small.jpg" alt="">
												</div>
							...
							<div class="panel panel-white">
								<div class="panel-heading border-light">
									...
									<ul class="panel-heading-tabs border-light">
										...
										<li>
											<div class="rate">
												<i class="fa fa-caret-up text-green"></i><span class="value">15</span><span
										...
										<li class="panel-tools">
											...
											</div> <a class="btn btn-xs btn-link panel-close" href="#"> <i
												class="fa fa-times"></i>
										</a>
										</li>
									</ul>
							...
							<div class="panel panel-red panel-calendar">
								<div class="panel-heading border-light">
									...
									<div class="panel-tools">
										<div class="dropdown">
											<a data-toggle="dropdown"
												class="btn btn-xs dropdown-toggle btn-transparent-white">
												<i class="fa fa-cog"></i>
											</a>
											<ul class="dropdown-menu dropdown-light pull-right"
												role="menu">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="actual-date">
													<span class="actual-day"></span> <span class="actual-month"></span>
												</div>
											</div>
											<div class="col-xs-6">
												<div class="row">
											...
											<div class="col-xs-12">
												<div class="row">
													<div
														...
														<a class="btn btn-sm owl-prev text-light"> <i
															...
															<div class="item">
																<div
																	...
																	<span class="bold-text text-small"><i
																		class="fa fa-clock-o"></i> 17:00</span> <span
																		class="text-light text-extra-small">1 hour</span>
																</div>
																<div class="inline-block padding-10">
																	<span class="bold-text text-small">NETWORKING</span> <span
																		class="text-light text-small">Out to design
																		conference</span>
																</div>
															</div>
															<div class="item">
																<div
																	class="inline-block padding-10 border-right border-light">
																	<span class="bold-text text-small"><i
																		class="fa fa-clock-o"></i> 18:30</span> <span
																		class="text-light text-extra-small">30 mins</span>
																</div>
																<div class="inline-block padding-10">
																	<span class="bold-text text-small">BOOTSTRAP
																		SEMINAR</span> <span class="text-light text-small">Problem
																		Solving</span>
																</div>
															</div>
															<div class="item">
																<div
																	class="inline-block padding-10 border-right border-light">
																	<span class="bold-text text-small"><i
																		class="fa fa-clock-o"></i> 20:00</span> <span
																		class="text-light text-extra-small">2 hour</span>
																</div>
																<div class="inline-block padding-10">
																	<span class="bold-text text-small">Lunch with
																		Nicole</span> <span class="text-light text-small">Next
																		on Tuesday</span>
																</div>
															</div>
														</div>
										...
										<div class="row">
											<div class="col-xs-12">
												<div class="pull-right">
													<a href="#newEvent"
														class="btn btn-sm btn-transparent-white new-event"><i
														class="fa fa-plus"></i> New Event </a> <a href="#showCalendar"
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													<a href="#collapseTwo" data-parent="#accordion"
														...
														class="accordion-toggle padding-15 collapsed"> <i
														class="icon-arrow"></i> Last Month
													</a>
												</h4>
											</div>
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													<a href="#collapseThree" data-parent="#accordion"
														data-toggle="collapse"
														class="accordion-toggle padding-15 collapsed"> <i
														class="icon-arrow"></i> Two Months Ago
													</a>
												</h4>
											</div>
							...
							<div class="row">
										...
										<div class="panel-body padding-20 text-center">
											<div class="space10">
												...
												<h3 class="text-white no-margin">
													<span class="text-small">&#36;</span>1,450
												</h3>
												253 Sales
											</div>
											...
											<span class="text-light"><i class="fa fa-clock-o"></i>
												1 hour ago</span>
										</div>
									</div>
								</div>
									...
									<div class="panel panel-green">
										<div class="panel-body padding-20 text-center">
											<div class="space10">
												...
												<h3 class="text-white no-margin">
													<span class="text-small">&#36;</span>1,250
												</h3>
												198 Sales
											</div>
									...
									<div class="panel">
										<div class="panel-body">
											<div class="easy-pie-chart">
												<span class="cpu number appear" data-percent="82"
													data-plugin-options='{"barColor": "#ff0000"}'> <span
													class="percent"></span>
												</span>
											...
											<div class="small-text text-center space15">
												<span class="block">Recommended</span><span
								...
								<div class="col-sm-6">
									<div class="panel">
										<div class="panel-body">
											<div class="easy-pie-chart">
												<span class="bounce number appear" data-percent="44"
													data-plugin-options='{"barColor": "#35aa47"}'> <span
													class="percent"></span>
												</span>
												<div class="label-chart">
											...
											<div class="text-center space15">
												<span class="block">Recommended</span><span
													class="label label-danger vertical-align-bottom">58%</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="panel-body no-padding">
									<div class="padding-10">
										<img width="50" height="50" alt=""
											...
											src="assets/images/avatar-1-big.jpg">
										<h4 class="no-margin inline-block padding-5">
											Peter Clark <span class="block text-small text-left">UI
												Designer</span>
										</h4>
										...
										<div class="col-xs-4 text-center no-padding">
											<div class="border-right border-dark">
												<a href="#" class="text-dark"> <i
													class="fa fa-heart-o text-red"></i> 250
												</a>
											</div>
										</div>
										<div class="col-xs-4 text-center no-padding">
											<div class="border-right border-dark">
												<a href="#" class="text-dark"> <i
													class="fa fa-bookmark-o text-green"></i> 20
												</a>
											</div>
										</div>
										<div class="col-xs-4 text-center no-padding">
											<a href="#" class="text-dark"><i
												class="fa fa-comment-o text-azure"></i> 544</a>
										</div>
									</div>
									<div class="tabbable no-margin no-padding partition-dark">
										<ul class="nav nav-tabs" id="myTab">
											<li class="active"><a data-toggle="tab"
												href="#users_tab_example1"> All </a></li>
											<li class=""><a data-toggle="tab"
												href="#users_tab_example2"> View and Edit </a></li>
											<li class=""><a data-toggle="tab"
												href="#users_tab_example3"> View Only </a></li>
										</ul>
										<div class="tab-content partition-white">
											<div id="users_tab_example1"
												class="tab-pane padding-bottom-5 active">
												<div class="panel-scroll height-230">
													<table class="table table-striped table-hover">
														<tbody>
															<tr>
																<td class="center"><img
																	src="assets/images/avatar-1.jpg" class="img-circle"
																	alt="image" /></td>
																<td><span class="text-small block text-light">UI
																		Designer</span><span class="text-large">Peter Clark</span><a
																	href="#" class="btn"><i class="fa fa-pencil"></i></a></td>
																<td class="center">
																	<div>
																		<div class="btn-group">
																			<a
																				class="btn btn-transparent-grey dropdown-toggle btn-sm"
																			...
																			<ul role="menu"
																				...
																				<li role="presentation"><a role="menuitem"
																					tabindex="-1" href="#"> <i class="fa fa-edit"></i>
																						Edit
																				</a></li>
																				<li role="presentation"><a role="menuitem"
																					tabindex="-1" href="#"> <i class="fa fa-share"></i>
																						Share
																				</a></li>
																				<li role="presentation"><a role="menuitem"
																					tabindex="-1" href="#"> <i class="fa fa-times"></i>
																						Remove
																				</a></li>
																			</ul>
																		</div>
															...
															<tr>
																<td class="center"><img
																	src="assets/images/avatar-2.jpg" class="img-circle"
																	alt="image" /></td>
																<td><span class="text-small block text-light">Content
																		Designer</span><span class="text-large">Nicole Bell</span><a
																	href="#" class="btn"><i class="fa fa-pencil"></i></a></td>
																<td class="center">
																	<div>
																		<div class="btn-group">
															...
															<tr>
																<td class="center"><img
																	src="assets/images/avatar-3.jpg" class="img-circle"
																	alt="image" /></td>
																<td><span class="text-small block text-light">Visual
																		Designer</span><span class="text-large">Steven
																		Thompson</span><a href="#" class="btn"><i
															...
															<tr>
																<td class="center"><img
																	src="assets/images/avatar-5.jpg" class="img-circle"
																	alt="image" /></td>
																<td><span class="text-small block text-light">Senior
																		Designer</span><span class="text-large">Kenneth Ross</span><a
																	href="#" class="btn"><i class="fa fa-pencil"></i></a></td>
																<td class="center">
																	<div>
																		<div class="btn-group">
															...
															<tr>
																<td class="center"><img
																	src="assets/images/avatar-4.jpg" class="img-circle"
																	alt="image" /></td>
																<td><span class="text-small block text-light">Web
																		Editor</span><span class="text-large">Ella Patterson</span><a
																	href="#" class="btn"><i class="fa fa-pencil"></i></a></td>
																<td class="center">
																	<div>
																		<div class="btn-group">
											...
											<div id="users_tab_example2"
												class="tab-pane padding-bottom-5">
												<div class="panel-scroll height-230">
													<table class="table table-striped table-hover">
														<tbody>
															<tr>
					...
					<div class="row">
						<div class="col-md-7 col-lg-4">
							<div class="panel panel-bricky">
								<div class="panel-heading border-light">
									<h4 class="panel-title">
										Next <span class="text-bold">Orders</span>
									</h4>
									<div class="panel-tools">
										<div class="dropdown">
											<a data-toggle="dropdown"
							...
							<div class="panel uploads">
								<div class="panel-body panel-portfolio no-padding">
										...
										<div class="overlayer bottom-left fullwidth">
											<div class="overlayer-wrapper">
												<div class="padding-20">
													...
													<h5 class="text-white">Take a look at what other users
														are uploading right now</h5>
												</div>
											</div>
										</div>
										<div
									...
									<div class="partition partition-white padding-15">
										<div class="navigator">
											<a href="#" class="circle-50 partition-white owl-prev"><i
												class="fa fa-chevron-left text-extra-large"></i></a> <a href="#"
												class="circle-50 partition-white owl-next"><i
												class="fa fa-chevron-right text-extra-large"></i></a>
										</div>
										<div class="clearfix space5">
											...
											<div class="col-xs-12 text-center no-padding">
												<a class="tags"> New York </a> <a class="tags"> London </a>
												<a class="tags"> Rome </a> <a class="tags"> Paris </a> <a
													class="tags"> Berlin </a> <a class="tags"> Amsterdam </a> <a
													class="tags"> Madrid </a>
											</div>
										</div>
						...
						<div class="col-lg-4 col-md-12">
							<div class="panel panel-green">
								<div class="panel-heading border-light">
									<span class="text-extra-small text-dark">LAST PROJECT: </span><span
										class="text-large text-white">Luxury Store</span>
									<div class="panel-tools">
										<div class="dropdown">
											<a data-toggle="dropdown"
												class="btn btn-xs dropdown-toggle btn-transparent-white">
								...
								<div class="panel-body no-padding">
									<div class="row no-margin">
										...
										<div class="padding-10 col-md-12">
											<div class="pull-left">
												<span
													class="background-dark padding-5 radius-5 text-small inline-block"><i
													class="fa fa-clock-o"></i> 43 days</span> <span
													class="background-dark padding-5 radius-5 text-small inline-block"><i
													class="fa fa-calendar-o"></i> January 04</span>
											</div>
											<div class="pull-right">
												<a href="#" class="btn btn-sm btn-transparent-white"><i
													class="fa fa-plus"></i> New Projext </a>
											</div>
										</div>
									</div>
									<div class="tabbable no-margin no-padding partition-dark">
										<ul class="nav nav-tabs" id="myTab2">
											<li class="active"><a data-toggle="tab"
												href="#todo_tab_example1"> To-do </a></li>
											<li class=""><a data-toggle="tab"
												href="#todo_tab_example2"> Next Week </a></li>
											<li class=""><a data-toggle="tab"
												href="#todo_tab_example3"> Next Month </a></li>
										</ul>
										<div class="tab-content partition-white">
											<div id="todo_tab_example1"
												class="tab-pane padding-bottom-5 active">
																...
																<div class="padding-horizontal-5">
																	...
																	<div class="block">
																		...
																		<div class="btn-group btn-group-sm todo-tools">
																			...
																			</a> <a class="btn" href="javascript:;"> <i
					...
					<div class="row">
						<div class="col-lg-8 col-md-7">
							<div class="panel panel-white">
								<div class="panel-heading border-light">
									<h4 class="panel-title">
										Site <span class="text-bold">Visits</span>
									</h4>
									<ul class="panel-heading-tabs border-light">
										<li>
											<div class="pull-right">
												<div class="btn-group">
													<a class="btn btn-green dropdown-toggle"
														data-toggle="dropdown" href="#"> Tools <span
														class="caret"></span>
													</a>
										...
										<li>
											<div class="rate">
												<i class="fa fa-caret-up text-green"></i><span class="value">11</span><span
													class="percentage">%</span>
											</div>
										</li>
										<li class="panel-tools">
						...
						<div class="col-lg-4 col-md-5">
							<div class="panel">
								<div class="panel-heading">
									<i class="clip-bars"></i>
									<h4 class="panel-title">
										Pageviews <span class="text-bold">real-time</span>
									</h4>
									<div class="panel-tools">
										<div class="dropdown">
											<a data-toggle="dropdown"
								...
								<div class="panel-body">
									<h3 class="inline">26</h3>
									visitors on-line
									<div class="progress progress-xs transparent-black no-radius">
										<div aria-valuetransitiongoal="12"
											class="progress-bar progress-bar-success partition-green animate-progress-bar"></div>
									</div>
									<div class="row">
										<div class="col-sm-4">
											<h4>15</h4>
											<div
												class="progress progress-xs transparent-black no-margin no-radius">
		...
		<!-- start: SUBVIEW SAMPLE CONTENTS --> <!-- *** NEW NOTE *** -->
	...
	<script src="js/historicalBarChart.js"></script>
