					...
					<div class="col-md-12">
						...
						<div class="panel panel-white">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square"></i>Add Nationality
								</h2>

								<hr>
								<form action="<%= application.getContextPath()%>/AddNationality" role="form" id="form2" method="post">
									<div class="row">
										<div class="col-md-12">
										...
										<div class="col-md-8">
											<div class="form-group">
												...
												</label> <input type="text" placeholder="Insert the Nationality"
													class="form-control" id="addnationality" name="addnationality">
											</div>
											<hr>
										</div>
