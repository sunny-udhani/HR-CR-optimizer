...
<title>Add Leave Entitlements</title>
<meta charset="utf-8" />
					...
					<div class="col-md-12">
						...
						<div class="panel panel-white">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square"></i>Add Leave Entitlements
								</h2>

								<hr>
								<form action="<%=application.getContextPath() %>/AddLeaveEntitlement" method="post" role="form" id="form2">
									<div class="row">
										<div class="col-md-12">
										...
										<div class="col-md-8">
											<div class="form-group">
												...
												</label> <select id="leaveentitlementemp" name="leaveentitlementemp" class="form-control search-select" >
											...
											<div class="form-group connected-group">
												...
												<div class="row">
													<div class="col-md-12">
														<select name="leaveentitlementLeaveType"
															id="leaveentitlementLeaveType" class="form-control">
															<option value="" selected="selected">--Select--</option>
											...
											<div class="form-group connected-group">
												...
												<div class="input-group">
													...
													</span> <input type="text" id="leaveentitlementperiod" name="leaveentitlementperiod" onmouseout="loadXMLDoc()" class="form-control date-range">
												</div>
											</div>
											 <h5>Entitlements (days)</h5>
											<input id="leaveentitlementdays" type="text" value="0" name="leaveentitlementdays">
											 </div>
										</div>
