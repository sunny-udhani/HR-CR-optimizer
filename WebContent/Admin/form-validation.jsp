				...
				<div class="col-md-4 col-sm-4">
					...
					<div class="blog-photo-stream margin-bottom-30">
						<ul class="list-unstyled">
							<li><a href="#"><img alt="" src="images/image01_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image02_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image03_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image04_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image05_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image06_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image07_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image08_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image09_th.jpg"></a>
							</li>
							<li><a href="#"><img alt="" src="images/image10_th.jpg"></a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="hidden-xs" id="style_selector">
					<div id="style_selector_container">
						...
						<div class="images icons-color">
							<a href="#" id="default"><img src="images/color-1.png" alt=""
								class="active"></a> <a href="#" id="style2"><img
								src="images/color-2.png" alt=""></a> <a href="#" id="style3"><img
								src="images/color-3.png" alt=""></a> <a href="#" id="style4"><img
								src="images/color-4.png" alt=""></a> <a href="#" id="style5"><img
								src="images/color-5.png" alt=""></a> <a href="#" id="style6"><img
								src="images/color-6.png" alt=""></a> <a href="#" id="style7"><img
								src="images/color-7.png" alt=""></a> <a href="#" id="style8"><img
								src="images/color-8.png" alt=""></a> <a href="#" id="style9"><img
								src="images/color-9.png" alt=""></a> <a href="#" id="style10"><img
								src="images/color-10.png" alt=""></a>
						</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
												...
												<div>
													<div class="checkbox">
														<label> <input type="checkbox" class="grey"
															value="" name="services" id="service1"> Service 1
														</label>
													</div>
													<div class="checkbox">
														<label> <input type="checkbox" class="grey"
															value="" name="services" id="service2"> Service 2
														</label>
													</div>
													<div class="checkbox">
														<label> <input type="checkbox" class="grey"
															value="" name="services" id="service3"> Service 3
														</label>
													</div>
													<div class="checkbox">
														<label> <input type="checkbox" class="grey"
															value="" name="services" id="service4"> Service 4
														</label>
													</div>
												</div>
											</div>
											...
											<div class="form-group connected-group">
												...
												</label> <input type="text" class="form-control" id="url" name="url">
											</div>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
						...
						<div class="form-group">
							<div class="fileupload fileupload-new contributor-avatar"
								...
								<div class="fileupload-new thumbnail">
									<img src="images/anonymous.jpg" alt="" width="50" height="50" />
								</div>
