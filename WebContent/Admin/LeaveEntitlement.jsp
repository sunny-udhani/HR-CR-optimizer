					...
					<div class="col-md-12">
						...
						<div class="panel panel-white">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square"></i>Assign Leave Entitlement
								</h2>
									...
									<div class="row">
										...
										<div class="col-md-8">
											<div class="form-group">
												...
												</label> <input type="text" placeholder="Insert the Emoployee Name"
													class="form-control" id="leaveentitlementemp"
													name="leaveentitlementemp">
											</div>
											...
											<div class="form-group connected-group">
												...
												<div class="row">
													<div class="col-md-3">
														<select name="assignleavetxtLeaveType"
															id="assignleavetxtLeaveType" class="form-control">
											...
											<div class="form-group connected-group">
												...
												<div class="input-group">
													...
													</span> <input type="text" name="leaveentitlementperiod" class="form-control date-range">
												</div>
											</div>
