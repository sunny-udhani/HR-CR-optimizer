...
<c:import url="/ViewLeaveList"></c:import>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-white">
							...
							<div class="panel-body">
								...
								<hr>
								<form action="<%=application.getContextPath()%>/ViewLeaveList" method="post" role="form" id="form2">
										...
										<div class="col-md-8">
											 ...
											 <div class="form-group connected-group">
												...
												<div class="input-group">
													...
													</span> <input type="text" id="viewleavelistperiod" name="viewleavelistperiod" class="form-control date-range">
												</div>
											</div>
											 ...
											 <div class="form-group connected-group">
												...
												<div class="checkbox-table">
														<label>
															<input type="checkbox" class="flat-grey selectall" name="viewleaveliststatus" id="viewleaveliststatus" value="0">
														</label>
													</div>All	 
													 <c:forEach items="${sessionScope.statuslist }" var="wol">
														...
														<div class="checkbox-table">
															<label>
																<input type="checkbox" class="flat-grey foocheck" name="viewleaveliststatus" id="viewleaveliststatus" value="${wol.id}">
															</label>
														</div>${wol.status} &nbsp;
													 </c:forEach>
													 <script>
											...
											<div class="form-group">
												<label class="control-label"> Employee 
												 ...
												 <select id="viewleavelistemp" name="viewleavelistemp" class="form-control search-select" >
											...
											<div class="form-group connected-group">
												...
												<div class="row">
													<div class="col-md-3">
														<select name="viewleavelisttype"
															id="viewleavelisttype" class="form-control">
