					...
					<div class="col-md-12">
						...
						<div class="panel panel-white">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square"></i>Add Leave Type
								</h2>

								<hr>
								<form action="<%= application.getContextPath()%>/AddLeaveType" role="form" id="form2" method="post">
									<div class="row">
										<div class="col-md-12">
										...
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label">Leave Type Name<span
													class="symbol required"></span>
												</label> <input type="text" placeholder=""
													class="form-control" id="addleavetypename" name="addleavetypename">
											</div>
										</div>
