...
!function (a) {
    ...
    b.prototype = {
        ...
        submit: function (b) {
            ...
            this.showForm(),
            void 0;
            if (!this.options.savenochange && this.input.value2str(c) == this.input.value2str(this.value)) return this.$div.triggerHandler('nochange'),
            void 0;
...
function (a) {
    ...
    b.prototype = {
        ...
        init: function (c, d) {
            this.$element = a(c),
            this.options = a.extend({
            }, a.fn.editableContainer.defaults, d),
            this.splitOptions(),
        ...
        splitOptions: function () {
            ...
            }, !a.fn[this.containerName]) throw new Error(this.containerName + ' not found. Have you included corresponding js file?');
...
function (a) {
    ...
    var b = function (b, c) {
        this.$element = a(b),
        this.options = a.extend({
        }, a.fn.editable.defaults, c, a.fn.editableutils.getConfigData(this.$element)),
            ...
            case 'submit':
                ...
                if (a.isEmptyObject(i)) {
                    ...
                    j.success = 'function' == typeof g.success ? function (a) {
                     ...
                     : a.noop,
                    j.error = 'function' == typeof g.error ? function () {
...
function (a) {
    ...
    a.extend(b.prototype, {
        ...
        onSourceReady: function (b, c) {
            var d;
            if (a.isFunction(this.options.source) ? (d = this.options.source.call(this.options.scope), this.sourceData = null)  : d = this.options.source, this.options.sourceCache && a.isArray(this.sourceData)) return b.call(this),
            void 0;
            try {
            ...
            if ('string' == typeof d) {
                if (this.options.sourceCache) {
                    var f,
                    g = d;
                    if (a(document).data(g) || a(document).data(g, {
                    }), f = a(document).data(g), f.loading === !1 && f.sourceData) return this.sourceData = f.sourceData,
                    this.doPrepend(),
                    b.call(this),
                    void 0;
...
function (a) {
    ...
    b.defaults = a.extend({
    }, a.fn.editabletypes.list.defaults, {
        tpl: '<select></select>'
    }),
...
function (a) {
    ...
    a.extend(b.prototype, {
        ...
        str2value: function (b) {
            var c,
            d = null;
            return 'string' == typeof b && b.length ? (c = new RegExp('\\s*' + a.trim(this.options.separator) + '\\s*'), d = b.split(c))  : d = a.isArray(b) ? b : [
                b
            ],
            d
        },
        value2input: function (b) {
            ...
            a.isArray(b) && b.length && this.$input.each(function (c, d) {
                var e = a(d);
...
function (a) {
    ...
    b.defaults = a.extend({
    }, a.fn.editabletypes.text.defaults, {
...
function (a) {
    'use strict';
    var b = function (c) {
        if (this.init('select2', c, b.defaults), c.select2 = c.select2 || {
        }, this.sourceData = null, c.placeholder && (c.select2.placeholder = c.placeholder), !c.select2.tags && c.source) {
            var d = c.source;
            a.isFunction(c.source) && (d = c.source.call(c.scope)),
            'string' == typeof d ? (c.select2.ajax = c.select2.ajax || {
        ...
        if (this.options.select2 = a.extend({
        }, b.defaults.select2, c.select2), this.isMultiple = this.options.select2.tags || this.options.select2.multiple, this.isRemote = 'ajax' in this.options.select2, this.idFunc = this.options.select2.id, 'function' != typeof this.idFunc) {
...
function (a) {
    var b = function (b, c) {
        ...
        this.$element.is('input') ? (this.options = a.extend({
        }, a.fn.combodate.defaults, c, this.$element.data()), this.init(), void 0)  : (a.error('Combodate should be applied to INPUT element'), void 0)
    };
    b.prototype = {
        constructor: b,
        init: function () {
            ...
            this.initCombos(),
            this.$widget.on('change', 'select', a.proxy(function (b) {
                this.$element.val(this.getValue()).change(),
                this.options.smartDays && (a(b.target).is('.month') || a(b.target).is('.year')) && this.fillCombo('day')
            }, this)),
        ...
        fillDay: function () {
            ...
            if (this.options.smartDays && this.$month && this.$year) {
                ...
                isNaN(f) || isNaN(g) || (e = moment([g,
                f]).daysInMonth())
            }
            for (b = 1; e >= b; b++) a = d ? this.leadZero(b)  : b,
            c.push([b,
            a]);
            return c
        },
        ...
        fillYear: function () {
            ...
            c[this.options.yearDescending ? 'push' : 'unshift']([b,
            a]);
        ...
        fillHour: function () {
            ...
            f = d ? 1 : 0,
            g = d ? 12 : 23;
            for (b = f; g >= b; b++) a = e ? this.leadZero(b)  : b,
            c.push([b,
            a]);
            return c
        },
        ...
        getValue: function (b) {
            ...
            return a.each(this.map, function (a) {
                if ('ampm' !== a) {
                    var b = 'day' === a ? 1 : 0;
                    return d[a] = e['$' + a] ? parseInt(e['$' + a].val(), 10)  : b,
                    isNaN(d[a]) ? (f = !0, !1)  : void 0
                }
            }),
            f ? '' : (this.$ampm && (d.hour = 12 === d.hour ? 'am' === this.$ampm.val() ? 0 : 12 : 'am' === this.$ampm.val() ? d.hour : d.hour + 12), c = moment([d.year,
            d.month,
            d.day,
            d.hour,
            d.minute,
            d.second]), this.highlight(c), b = void 0 === b ? this.options.format : b, null === b ? c.isValid() ? c : null : c.isValid() ? c.format(b)  : '')
        },
        setValue: function (b) {
            function c(b, c) {
                var d = {
    ...
    a.fn.combodate = function (c) {
        ...
        return e.shift(),
        'getValue' === c && this.length && (d = this.eq(0).data('combodate')) ? d.getValue.apply(d, e)  : this.each(function () {
            var d = a(this),
            f = d.data('combodate'),
            g = 'object' == typeof c && c;
...
function (a) {
    ...
    var b = function (c) {
        ...
        }, b.defaults.combodate, c.combodate, {
    ...
    a.extend(b.prototype, {
        render: function () {
            ...
            'bs3' === a.fn.editableform.engine && this.$input.siblings().find('select').addClass('form-control'),
...
function (a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        ...
        initInput: function () {
            ...
            for (var f = this.$form.find('.editable-buttons'), g = c ? [
                d
            ] : this.input.options.inputclass.split(' '), h = 0; h < g.length; h++) 'input-lg' === g[h].toLowerCase() && f.find('button').removeClass('btn-sm').addClass('btn-lg')
        }
    }),
    a.fn.editableform.buttons = '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="fa fa-check"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="fa fa-trash-o"></i></button>',
...
function (a) {
    ...
    _applyEvents: function (a) {
        for (var b, c, d = 0; d < a.length; d++) b = a[d][0],
        c = a[d][1],
        b.on(c)
},
...
var d = c || this.date,
e = new Date(d.getTime() + 60000 * d.getTimezoneOffset());
...
return void 0 === a && (a = this.o.format),
...
var a,
b = !1;
arguments && arguments.length && ('string' == typeof arguments[0] || arguments[0] instanceof Date) ? (a = arguments[0], b = !0)  : (a = this.isInput ? this.element.val()  : this.element.data('date') || this.element.find('input').val(), delete this.element.data().date),
this.date = l.parseDate(a, this.o.format, this.o.language),
b && this.setValue(),
this.viewDate = this.date < this.o.startDate ? new Date(this.o.startDate)  : this.date > this.o.endDate ? new Date(this.o.endDate)  : new Date(this.date),
this.fill()
}
},
fillDow: function () {
...
var o = new Date(m);
o.setUTCDate(o.getUTCDate() + 42),
o = o.valueOf();
for (var p, q = [
]; m.valueOf() < o; ) {
if (m.getUTCDay() == this.o.weekStart && (q.push('<tr>'), this.o.calendarWeeks)) {
var r = new Date( + m + 86400000 * ((this.o.weekStart - m.getUTCDay() - 7) % 7)),
s = new Date( + r + 86400000 * ((11 - r.getUTCDay()) % 7)),
t = new Date( + (t = b(s.getUTCFullYear(), 0, 1)) + 86400000 * ((11 - t.getUTCDay()) % 7)),
u = (s - t) / 86400000 / 7 + 1;
q.push('<td class="cw">' + u + '</td>')
}
p = this.getClassNames(m),
p.push('day');
...
p = a.unique(p),
q.push('<td class="' + p.join(' ') + '"' + (c ? ' title="' + c + '"' : '') + '>' + m.getUTCDate() + '</td>'),
...
d.is('.old') ? 0 === j ? (j = 11, k -= 1)  : j -= 1 : d.is('.new') && (11 == j ? (j = 0, k += 1)  : j += 1),
...
b = 37 == a.keyCode ? - 1 : 1,
a.ctrlKey ? (c = this.moveYear(this.date, b), d = this.moveYear(this.viewDate, b))  : a.shiftKey ? (c = this.moveMonth(this.date, b), d = this.moveMonth(this.viewDate, b))  : (c = new Date(this.date), c.setUTCDate(this.date.getUTCDate() + b), d = new Date(this.viewDate), d.setUTCDate(this.viewDate.getUTCDate() + b)),
...
if (!this.o.keyboardNavigation) break;
b = 38 == a.keyCode ? - 1 : 1,
a.ctrlKey ? (c = this.moveYear(this.date, b), d = this.moveYear(this.viewDate, b))  : a.shiftKey ? (c = this.moveMonth(this.date, b), d = this.moveMonth(this.viewDate, b))  : (c = new Date(this.date), c.setUTCDate(this.date.getUTCDate() + 7 * b), d = new Date(this.viewDate), d.setUTCDate(this.viewDate.getUTCDate() + 7 * b)),
this.dateWithinRange(c) && (this.date = c, this.viewDate = d, this.setValue(), this.update(), a.preventDefault(), e = !0);
break;
case 13:
this.hide(),
...
yy: function (a, b) {
return a.setUTCFullYear(2000 + b)
},
m: function (a, b) {
for (b -= 1; 0 > b; ) b += 12;
...
for (var u, m = 0; m < q.length; m++) u = q[m],
...
e.mm = (e.m < 10 ? '0' : '') + e.m;
for (var b = [
], f = a.extend([], c.separators), g = 0, h = c.parts.length; h >= g; g++) f.length && b.push(f.shift()),
b.push(e[c.parts[g]]);
return b.join('')
},
...
var c,
d = null;
return a && (d = this.dpg.parseDate(a, b, this.options.datepicker.language), 'string' == typeof a && (c = this.dpg.formatDate(d, b, this.options.datepicker.language), a !== c && (d = null))),
d
}
}),
b.defaults = a.extend({
...
b.defaults = a.extend({
}, a.fn.editabletypes.date.defaults, {
...
}, c.datetimepicker, b.datetimepicker, {
format: this.options.viewformat
}),
...
toUTC: function (a) {
return a ? new Date(a.valueOf() - 60000 * a.getTimezoneOffset())  : a
},
fromUTC: function (a) {
return a ? new Date(a.valueOf() + 60000 * a.getTimezoneOffset())  : a
},
...
var c,
d = null;
return a && (d = this.dpg.parseDate(a, b, this.options.datetimepicker.language, this.options.formatType), 'string' == typeof a && (c = this.dpg.formatDate(d, b, this.options.datetimepicker.language, this.options.formatType), a !== c && (d = null))),
d
}
}),
b.defaults = a.extend({
...
b.defaults = a.extend({
}, a.fn.editabletypes.datetime.defaults, {
tpl: '<div class="input-append date"><input type="text"/><span class="add-on"><i class="icon-th"></i></span></div>',
inputclass: 'input-medium',
datetimepicker: {
todayHighlight: !1,
