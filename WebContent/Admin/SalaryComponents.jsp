						...
						<div class="panel panel-white">
							<div class="panel-heading">
								<h4 class="panel-title">
									<span class="text-bold">Salary</span>
								</h4>
								<%@ include file="Paneltools.jsp" %>
							</div>
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square"></i>Add Salary Components
								</h2>
									...
									<div class="row">
										...
										<div class="col-md-7">
											<div class="form-group">
												<label class="control-label"> Component Name <span
													class="symbol required"></span>
												</label> <input type="text" placeholder="Insert the Component Name"
													class="form-control" id="salarycomponentname"
													name="salarycomponentname"> <br> 
													</div>
													<div class="form-group">
													<label
													class="col-md-2 control-label"> Type<span
													class="symbol required"></span>&nbsp;
												</label> <label class="radio-inline"> <input type="radio"
													value="" name="salarycomponenttype"> Earning
												</label> <label class="radio-inline"> <input type="radio"
													value="" name="salarycomponenttype"> Deduction
												</label>
											</div>
											<hr>
											<div class="form-group">
												<label class="col-md-2 control-label"> Add to<span
													class="symbol required"></span>&nbsp;
												</label> <label class="checkbox-inline"> <input
													type="checkbox" value="" name="salarycomponentaddto" id="1"> Cost
													to Company
												</label> <label class="checkbox-inline"> <input
													type="checkbox" value="" name="salarycomponentaddto" id="2"> Total
													Payable
												</label>
											...
											<div class="form-group">
												<label class="col-md-2 control-label"> Value Type<span
													class="symbol required"></span>&nbsp;
												</label> <label class="radio-inline"> <input type="radio"
													value="1" name="salarycomponentvaluetype"> Amount
												</label> <label class="radio-inline"> <input type="radio"
													value="2" name="salarycomponentvaluetype"> Percentage
												</label>
