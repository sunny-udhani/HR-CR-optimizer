...
<c:import url="/EmployeeLeaveEntitlementView"></c:import>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-white">
							...
							<div class="panel-body">
								...
								<hr>
								<form action="<%=application.getContextPath()%>/EmployeeLeaveEntitlementView" method="post" role="form" id="form2">
									...
									<div class="row">
										...
										<div class="col-md-8">
											...
											<div class="form-group connected-group">
												...
												<div class="row">
													<div class="col-md-12">
														<select name="EmployeeLeaveEntitlementViewtype"
															id="EmployeeLeaveEntitlementViewtype" class="form-control">
