									...
									<div class="row">
										...
										<div class="col-md-8">
											<div class="form-group connected-group" >
												...
												<label class="control-label" style="width:100px"> User Roles: 
												</label>
												<br>
												...
												<select id="adduseressrole" name="adduseressrole" class="form-control search-select">
												</select>
												<br>
												<label class="control-label"> Supervisor Role <span
													class="symbol required"></span>
												</label>
												<select id="addusersupervisorrole" name="addusersupervisorrole" class="form-control search-select">
												</select>
												<br>
												<label class="control-label"> Admin Role <span
													class="symbol required"></span>
												</label>
												<select id="adduseradminrole" name="adduseradminrole" class="form-control search-select">
												</select>
											</div>
											<br>
											<hr>
											...
											<div class="form-group">
												...
												<input type="text" name="adduseremployeename" id="adduseremployeename" class="form-control">
											</div>
											...
											<div class="form-group">
												...
												<input type="text" id="adduserusername" name="adduserusername" class="form-control">
											</div>
											...
											<div class="form-group connected-group">
												...
												<select id="adduserstatus" name="adduserstatus" class="form-control search-select">
												</select>
											</div>
											<br>
											<div class="form-group connected-group">
												...
												<input type="password" placeholder="Type Password" id="password" name="password" class="form-control">
											</div>
											<br>
											<div class="form-group connected-group">
												<label class="control-label" for="form-field-2">
													...
													<input type="password" placeholder="Type Password Again" id="password_again" name="password_again" class="form-control">
												</div>
											</div>
