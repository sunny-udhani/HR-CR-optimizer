						...
						<div class="panel panel-white">
							<div class="panel-heading">
								<h4 class="panel-title">
									General <span class="text-bold">Information</span>
								</h4>
								<%@ include file="Paneltools.jsp" %>
							</div>
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square"></i> ORGANIZATION DETAILS
								</h2>
								<p>Create your organization details & publish it.</p>
								<hr>
										...
										<div class="col-md-7">
											<div class="form-group">
												<label class="control-label"> Organization Name <span
													...
													class="form-control" id="orgdetailsorganizationname"
													name="orgdetailsorganizationname">
											</div>
											<div class="form-group">
												<label class="control-label"> Number Of Employees <span
													class="symbol required"></span>
												</label> <input type="text" placeholder="Insert Number Of Employees"
													class="form-control" id="orgdetailsnumberofemployee"
													name="orgdetailsnumberofemployee">
											</div>
											<div class="form-group">
												<label class="control-label"> Email Address <span
													class="symbol required"></span>
												</label> <input type="email" placeholder="Enter Email Address"
													class="form-control" id="orgdetailsemail" name="orgdetailsemail">
											</div>
											<div class="form-group">
												<label class="control-label"> Address Street
												</label> <input type="text" class="form-control" name="orgdetailsaddress1"
													id="orgdetailsaddress1">
											</div>
											<div class="form-group">
												<label class="control-label"> Country <span
													class="symbol required"></span>
												</label> <select class="form-control" id="orgdetailscountry" name="orgdetailscountry">
												...
												<div class="form-group">
													<label class="control-label"> Tax ID<em>(Optional)</em>
													</label> <input type="text" placeholder="Tax-ID"
														class="form-control" id="taxid" name="taxid">
												</div>
												<div class="form-group">
													<label class="control-label"> Registration Number <em>(Optional)</em>
													</label> <input type="text" placeholder="Registration Number"
														class="form-control" id="registrationnuumber"
														name="registrationnuumber">
												</div>
												<div class="form-group">
													<label class="control-label"> Phone <span
														class="symbol required"></span>
													</label> <input type="text" class="form-control" id="orgdetailsphone"
														name="orgdetailsphone">
												</div>
												<!-- <div class="form-group">
													<label class="control-label"> Address Street2<em>(Optional)</em>
													</label> <input type="text" class="form-control" name="address1"
														id="address1">
												</div> -->
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label"> Zip Code <span
																class="symbol required"></span>
															</label> <input class="form-control" type="text" name="orgdetailszipcode"
																id="orgdetailszipcode">
														</div>
													</div>
													<div class="col-md-8">
														<div class="form-group">
															<label class="control-label"> City <span
																...
																name="orgdetailscity" id="orgdetailscity">
														</div>
													</div>
												</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label"> Occupation Details </label>
