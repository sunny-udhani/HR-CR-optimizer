							...
							<div class="col-sm-6">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<label class="radio-inline">
										<input class="grey" type="radio" name="optionsRadios" value="" style="position: absolute; top: -10%; left: -10%; display: block; w…roll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;"></input>

<ins class="iCheck-helper" style="position: absolute; top: -10%; left: -10%; display: block; w…roll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;"></ins>
											<input type="radio" value="" name="optionsRadios" class="grey">
											Radio Button 2
										</label>
